...
void readParameters(string config_file)
{
    ...
    cam_K = (cv::Mat_<float>(3,3) << fsSettings["projection_parameters"]["fx"],0.0,fsSettings["projection_parameters"]["cx"],0.0,fsSettings["projection_parameters"]["fy"],fsSettings["projection_parameters"]["cy"],0.0,0.0,1.0);
//    cam_dist = (cv::Mat_<double>(5,1) << fsSettings["distortion_parameters"]["k1"],fsSettings["distortion_parameters"]["k2"],fsSettings["distortion_parameters"]["p1"],fsSettings["distortion_parameters"]["p2"],fsSettings["distortion_parameters"]["k3"]);
    cam_dist = (cv::Mat_<float>(4,1) << fsSettings["distortion_parameters"]["k1"],fsSettings["distortion_parameters"]["k2"],fsSettings["distortion_parameters"]["p1"],fsSettings["distortion_parameters"]["p2"]);

//    cam_dist = (cv::Mat_<float>(4,1) << 0.0,0.0,0.0,0.0);
